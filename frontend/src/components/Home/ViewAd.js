...
export default function ViewAd() {
  ...
  console.log(
    "🚀 ~ file: ViewAd.js ~ line 29 ~ ViewAd ~ advertisement",
    advertisement
  );
                      ...
                      <Row>
                        ...
                        <Col md={6} style={{ height: "100vh" }}>
                          ...
                          <Row style={{ textAlign: "left" }}>
                            <Col md={12}>
                              <b>Phone Number: </b>
                              {advertisement.serviceProvider.phoneNumber.map(
                                (number) => (
                            ...
                            <Col md={12}>
                              <b>Email: </b>
                              {advertisement.serviceProvider.email}
                            </Col>
                            <Col md={12}>
                              <b>Location: </b>
                              {advertisement.location.text}
                            </Col>
                            <Col md={12}>
                            ...
                            <Col md={12}>
                              <b>Tags: </b>
                              {advertisement.keywords.map((keyword) => (
                            ...
                            {checkAuth() && (
                              ...
                              >
                                <Button
                                  ...
                                  color="success"
                                  onClick={() =>
                                    goToOrderPage(advertisement.id)
                                  }
                                >
                                  Order Service
                                </Button>
                            ...
                            <Col style={{ minHeight: "35vh" }}>
                              <hr />
                              <Map
                                lan={advertisement.location.lan}
